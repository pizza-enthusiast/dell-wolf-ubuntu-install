...
# Patch for wolf touchpad (Dell Chromebook)
wget -O - http://pastie.org/pastes/8901894/download | sed 's/drivers\/platform\/x86\/chromeos_laptop.c/drivers\/platform\/chrome\/chromeos_laptop.c/g'| patch -p1
